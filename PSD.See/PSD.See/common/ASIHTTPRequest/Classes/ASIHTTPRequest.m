...
+ (id)requestWithURL:(NSString *)newURL onTarget:(id)target andFinishSelector:(SEL)finishSelector andFailSelector:(SEL)failSeletor
{
    NSURL* url = [NSURL URLWithString:newURL];
    ASIHTTPRequest* request = [[[self alloc] initWithURL:url] autorelease];
    request.didFinishSelector = finishSelector;
    request.didFailSelector = failSeletor;
